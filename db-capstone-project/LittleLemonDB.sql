...
-- -----------------------------------------------------
-- Table `mydb`.`CustomersDetails`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`CustomersDetails` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Bookings` (
  ...
  CONSTRAINT `fk_Bookings_Customers Detail`
    ...
    REFERENCES `mydb`.`CustomersDetails` (`CustomerID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Orders` (
  ...
  CONSTRAINT `fk_Orders_Staff Information1`
    ...
    REFERENCES `mydb`.`Staff Information` (`StaffID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Order Items` (
